...
public class UrlUtils {
    ...
    private static Pattern CONTENT_NONSTATIC_PATTERN = Pattern.compile("^[\\d_\\-]{4,}$", Pattern.CASE_INSENSITIVE);

    private static Pattern CONTENT_DICT_PATTERN = Pattern.compile("(detail|article|view|show)$", Pattern.CASE_INSENSITIVE);

    private static Pattern CONTENT_NONSTATIC_KEYWORD_PATTERN = Pattern.compile("[\\w\\d\\-]*(detail|article)[\\w\\d\\-]*\\d{4,}$", Pattern.CASE_INSENSITIVE);

    private static Pattern CONTENT_HASH_PATTERN = Pattern.compile("[\\w\\d-]*\\d+[\\w\\d\\-]", Pattern.CASE_INSENSITIVE);

    private static Pattern CONTENT_QUERY_PATTERN = Pattern.compile("id=\\d{4,}", Pattern.CASE_INSENSITIVE);
    ...
    public static boolean guessContentUrl(String url) {
